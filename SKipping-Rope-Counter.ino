...
const char* AP_SSID = "Skipping Rope Counter";
boolean SETUP_MODE;
String SSID_LIST;
...
// Device Definitions //
/////////////////////////
String DEVICE_TITLE = "Skipping Rope Counter";
...
void setup() {
   ...
   aLastState = digitalRead(outputA);
    ...
    // wifiManager.resetSettings();
     wifiManager.autoConnect("Skipping Rope Counter");
      ...
      if(buttonPushCounter %2 ==0)
        {
          ...
          if (counter >= 5) {
            ...
            if(skippingRate < 100) met=8.8;
              ...
              if(score%21 == 0) 
              {
                skippingRate = (60000*score)/(millis()-startTime);
